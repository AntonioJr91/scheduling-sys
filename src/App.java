...
public class App {
        public static void main(String[] args) throws Exception {
                ...
                Doctor d1 = new Doctor("house", "house@example.com", LocalDate.of(1900, 1, 1),
                                Specialty.GENERAL_PRACTITIONER);
                Doctor d2 = new Doctor("stevan", "stevan@example.com", LocalDate.of(1900, 5, 5),
                ...
                List<String> options = Arrays.asList(
                                "All Patients", "Find Patient By Name", "Add New Patient", "Update Patient",
                                "Delete Patient",
                                "All Doctors", "Find Doctor By Name", "Add New Doctors", "Update Doctors",
                                "Delete Doctors",
                                "All Appointments", "Find Appointment By ID", "Add New Appointment",
